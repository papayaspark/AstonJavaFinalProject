...
/**
 * TODO: Реализовать класс Студент (Номер группы, Средний балл, Номер зачетной книжки) из задания.
 ...
 * src/main/resources. В первом файле 15-20 строк вроде "Номер группы, Средний балл, Номер зачетной книжки"
 * (без кавычек), все строки хорошие (валидные). Во втором файле - плохие строки, количество на ваше усмотрение.
 * Из этих файлов будут считываться данные в главном цикле.
 */

public class Student implements ThreeFieldedClass {
    @Override
